...
// --- Global Variables ---
// Keep these global as they maintain state across operations
let cy;
let currentConfig = null;
let defaultGraphStructure = null;
let sessionLog = [];
let contextMenuInstance = null; // Edge handles removed
let newNodeCounter = 0;
let didRegisterContextMenus = false;
let edgeSourceNode = null;

// ========================================================
// --- MAIN INITIALIZATION AND FUNCTION DEFINITIONS ---
// ========================================================

// Wrap the entire application logic inside DOMContentLoaded
document.addEventListener('DOMContentLoaded', async () => {
    ...
    // --- DEFINE ALL FUNCTIONS *INSIDE* DOMContentLoaded ---
    // (Or define them outside but ensure they are called only after this point)
    ...
    // Define this function before calling it in DOMContentLoaded listener
    ...
    // ==================================================
    // This now runs *after* all the above functions are defined.
...
console.log("script.js loaded and parsed. Waiting for DOMContentLoaded."); // Log outside listener
